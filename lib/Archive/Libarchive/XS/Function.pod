...
These are created with L<archive_read_new|Archive::Libarchive::XS::Function#archive_read_new>, L<archive_write_new|Archive::Libarchive::XS::Function#archive_write_new> or
L<archive_write_disk_new|Archive::Libarchive::XS::Function#archive_write_disk_new> and deleted with L<archive_read_free|Archive::Libarchive::XS::Function#archive_read_free> or 
L<archive_write_free|Archive::Libarchive::XS::Function#archive_write_free>.
...
These are created with L<archive_entry_new|Archive::Libarchive::XS::Function#archive_entry_new> and deleted with
L<archive_entry_free|Archive::Libarchive::XS::Function#archive_entry_free>.  They can also be returned by L<archive_read_next_header|Archive::Libarchive::XS::Function#archive_read_next_header>,
...
L<archive_entry_acl_clear|Archive::Libarchive::XS::Function#archive_entry_acl_clear>, L<archive_entry_acl_add_entry|Archive::Libarchive::XS::Function#archive_entry_acl_add_entry>, L<archive_entry_acl_text|Archive::Libarchive::XS::Function#archive_entry_acl_text>.
...
Returns a textual name identifying the indicated filter.  See L<archive_filter_count|Archive::Libarchive::XS::Function#archive_filter_count> for
...
A convenience function that repeatedly calls L<archive_read_data_block|Archive::Libarchive::XS::Function#archive_read_data_block> to copy the entire entry to the provided file handle.
...
A convenience function that wraps the corresponding archive_write_disk interfaces.  The first call to L<archive_read_extract|Archive::Libarchive::XS::Function#archive_read_extract> creates a restore object using L<archive_write_disk_new|Archive::Libarchive::XS::Function#archive_write_disk_new> and
L<archive_write_disk_set_standard_lookup|Archive::Libarchive::XS::Function#archive_write_disk_set_standard_lookup>, then transparently invokes L<archive_write_disk_set_options|Archive::Libarchive::XS::Function#archive_write_disk_set_options>, L<archive_write_header|Archive::Libarchive::XS::Function#archive_write_header>, L<archive_write_data|Archive::Libarchive::XS::Function#archive_write_data>, and L<archive_write_finish_entry|Archive::Libarchive::XS::Function#archive_write_finish_entry> to
...
L<archive_write_disk_set_group_lookup|Archive::Libarchive::XS::Function#archive_write_disk_set_group_lookup>, and L<archive_write_disk_set_user_lookup|Archive::Libarchive::XS::Function#archive_write_disk_set_user_lookup>.  Note that L<archive_read_extract2|Archive::Libarchive::XS::Function#archive_read_extract2> does not accept a flags argument; you should use
...
A convenience form of L<archive_write_open|Archive::Libarchive::XS::Function#archive_write_open> that accepts a reference to a scalar that will receive the archive.
